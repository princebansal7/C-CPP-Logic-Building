...
// This way counter will increase every time we create a new object
// Static member variables shares memory with all the object and not doesn't gets created separately for each object
